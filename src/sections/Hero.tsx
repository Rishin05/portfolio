...
export default function Hero() {
    ...
    return (
        <section
            className="py-28 overflow-x-clip"
            id="hero"
            style={{
        ...
        >
            <div className="container relative">
                <motion.div
                    ...
                    drag
                    className="absolute -left-32 top-16 border border-cyan-50 hidden lg:block"
                >
                    <Image
                        src={hello}
                        alt=""
                ...
                <motion.div
                    ...
                    drag
                    className="absolute -right-64 -top-16 border border-cyan-50 hidden lg:block"
                >
                    <Image
                        src={hi}
                        alt=""
                ...
                <div className="flex justify-center">
                    <Image
                        src={laptopImage}
                        alt=""
                        className="size-[100px] md:size-[200px] lg:hidden"
                        draggable="false"
                    />
                </div>
                <div className=" flex justify-center">
                ...
                <h1 className="text-6xl md:text-7xl lg:text-xxl font-serif text-center mt-6">
                    Hi, I'm Rishin Patel
                </h1>
                <p className="text-center text-xl text-white mt-8 max-w-2xl mx-auto">
                    I'm a dedicated developer and tech enthusiast passionate
                    about crafting seamless web and mobile solutions.Let's
